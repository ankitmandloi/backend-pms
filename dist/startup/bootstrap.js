...
const ensureDefaultUser = async (logger) => {
...
const ensurePropertyProfile = async (logger) => {
...
const ensureTaxConfig = async (logger) => {
...
const ensureRoomTypes = async (logger) => {
...
const ensureFloors = async (logger) => {
...
const ensureRooms = async (logger) => {
...
const ensureGuests = async (logger) => {
...
const ensureReservations = async (logger) => {
    ...
    const guestByEmail = (email) => guests.find((guest) => guest.email === email);
...
export const bootstrapData = async (logger) => {
