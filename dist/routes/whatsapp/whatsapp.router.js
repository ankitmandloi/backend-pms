 ...
 */
whatsappRouter.get("/config", asyncHandler(async (req, res) => {
 ...
 */
whatsappRouter.put("/config", asyncHandler(async (req, res) => {
    const { hotelId, hotelCode } = req.user;
 ...
 */
whatsappRouter.post("/test-connection", asyncHandler(async (req, res) => {
    const { hotelId, hotelCode } = req.user;
 ...
 * Get all templates
 */
whatsappRouter.get("/templates", asyncHandler(async (req, res) => {
    const { hotelId, hotelCode } = req.user;
 ...
 */
whatsappRouter.get("/templates/:id", asyncHandler(async (req, res) => {
 ...
 * Create new template
 */
whatsappRouter.post("/templates", asyncHandler(async (req, res) => {
    const { hotelId, hotelCode } = req.user;
 ...
 * Update template
 */
whatsappRouter.put("/templates/:id", asyncHandler(async (req, res) => {
    const { hotelId } = req.user;
    const { id } = req.params;
 ...
 * Delete template
 */
whatsappRouter.delete("/templates/:id", asyncHandler(async (req, res) => {
    const { hotelId } = req.user;
    const { id } = req.params;
 ...
 */
whatsappRouter.post("/send", asyncHandler(async (req, res) => {
    const { hotelId, hotelCode } = req.user;
 ...
 * Get messages
 */
whatsappRouter.get("/messages", asyncHandler(async (req, res) => {
    const { hotelId, hotelCode } = req.user;
 ...
 */
whatsappRouter.post("/send-booking-confirmation/:reservationId", asyncHandler(async (req, res) => {
 ...
 */
whatsappRouter.post("/send-checkin-reminder/:reservationId", asyncHandler(async (req, res) => {
    const { reservationId } = req.params;
 ...
 */
whatsappRouter.post("/process-automated", asyncHandler(async (req, res) => {
    const { hotelId, hotelCode } = req.user;
