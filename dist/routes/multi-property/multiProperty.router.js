 ...
 */
multiPropertyRouter.get("/groups", asyncHandler(async (req, res) => {
 ...
 * Get specific group
 */
multiPropertyRouter.get("/groups/:id", asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 */
multiPropertyRouter.post("/groups", asyncHandler(async (req, res) => {
 ...
 */
multiPropertyRouter.put("/groups/:id", asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 */
multiPropertyRouter.delete("/groups/:id", asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 * Get all properties
 */
multiPropertyRouter.get("/properties", asyncHandler(async (req, res) => {
 ...
 */
multiPropertyRouter.get("/properties/:hotelId", asyncHandler(async (req, res) => {
 ...
 */
multiPropertyRouter.get("/groups/:id/properties", asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 */
multiPropertyRouter.get("/properties/:hotelId/features", asyncHandler(async (req, res) => {
    const { hotelId } = req.params;
 ...
 */
multiPropertyRouter.put("/properties/:hotelId/features", asyncHandler(async (req, res) => {
    const { hotelId } = req.params;
 ...
 */
multiPropertyRouter.get("/stats", asyncHandler(async (req, res) => {
 ...
 */
multiPropertyRouter.post("/switch/:hotelId", asyncHandler(async (req, res) => {
    const { hotelId } = req.params;
    const property = await multiPropertyService.switchProperty(hotelId);
    res.json({ success: true, data: property });
}));
//# sourceMappingURL=multiProperty.router.js.map