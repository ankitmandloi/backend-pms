...
export class BookingComAdapter extends BaseOTAAdapter {
    constructor() {
        super(...arguments);
        this.provider = "BOOKING_COM";
        this.USE_REAL_API = process.env.BOOKING_COM_API_ENABLED === 'true';
        this.API_BASE_URL = process.env.BOOKING_COM_API_URL || 'https://supply-xml.booking.com/hotels/xml';
        this.SANDBOX_URL = 'https://supply-xml.booking.com/hotels/xml/sandbox';
    }
    /**
...
//# sourceMappingURL=BookingComAdapter.js.map